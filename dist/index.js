...
var CATCH_ALL_RULE = [
  ...
  "  behaviour without one of those three shapes is high. A boundary error that reads or writes",
  "  one element wrong is high \u2014 shape 3 means loss or disclosure of protected payload to an",
  "  unintended reader, not an incorrect computation. When you are about to write critical, name",
  "  which of the three shapes holds; if none does, you have named the reason it is high.",
