...
var CATCH_ALL_RULE = [
  ...
  "",
  "And conclude decisively. Once you have read the diff and checked what the decisions above",
  "require, the review is over: conclude it. If two consecutive tool calls produced no new",
  "decision-relevant fact, that is your signal \u2014 re-reading a clean file a third time never makes",
  "it cleaner. A review that verifies forever is stopped by the harness and reports NOTHING,",
  "which is strictly worse than a decisive silence: the endless loop, not the missed nuance, is",
  "the failure mode that costs the whole review.",
  "",
